...
export default function CondicionesDeUso() {
    return (
        <div className="bg-background text-foreground min-h-screen py-24 px-6 md:px-12 pt-32">
            <div className="max-w-4xl mx-auto space-y-8">
                <h1 className="text-4xl font-bold mb-4 text-primary text-center">Condiciones Generales de Contratación y Uso</h1>
                <p className="text-sm text-muted-foreground text-center">Última actualización: {new Date().toLocaleDateString('es-ES')}</p>
